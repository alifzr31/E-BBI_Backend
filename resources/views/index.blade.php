...
<head>
    ...
    <link href="{{ url('https://fonts.googleapis.com/css?family=Playfair+Display:900|Roboto:400,400i,500,700') }}"
        rel="stylesheet" />
    <!--
      CSS
      =============================================
    ...
    <link rel="stylesheet" href="{{ url('css/hexagons.min.css') }}" />
    <link rel="stylesheet" href="{{ url('https://cdn.jsdelivr.net/themify-icons/0.1.2/css/themify-icons.css') }}" />
...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle text-white"
                                data-toggle="dropdown">{{ Auth::user()->siswa->nama }}</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="blog-home.html">Profile</a>
    ...
    <script src="{{ url('js/hexagons.min.js') }}"></script>
