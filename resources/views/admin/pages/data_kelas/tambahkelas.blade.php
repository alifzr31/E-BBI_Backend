        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin-storekelas') }}" method="POST" class="forms-sample">
                        @csrf
                        <div class="form-group">
                            ...
                            <select name="kls_angka" class="form-control @error('kls_angka') is-invalid @enderror"
                                ...
                                <option value="7" @if (old('kls_angka') == '7') selected @endif>7
                                </option>
                                <option value="8" @if (old('kls_angka') == '8') selected @endif>8
                                </option>
                                <option value="9" @if (old('kls_angka') == '9') selected @endif>9
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kls_huruf"
                                ...
                                placeholder="Kelas Huruf" value="{{ old('kls_huruf') }}">
